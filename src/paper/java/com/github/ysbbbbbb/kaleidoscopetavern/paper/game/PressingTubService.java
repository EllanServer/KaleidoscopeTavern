...
public final class PressingTubService implements PressingTubBlockBehavior.Handler {
    ...
    List<DisplayVisual> furnitureVisuals(BukkitFurniture furniture, int limit) {
    ...
    InteractionResult interactFurniture(BukkitFurniture furniture,
    ...
    Optional<ItemStack> furnitureIngredientDrop(BukkitFurniture furniture) {
        if (!isPressingTubFurniture(furniture)) {
