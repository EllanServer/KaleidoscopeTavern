...
public final class ShakerSemantics {
    ...
    public static ResultBand resultBand(int ticks) {
    ...
    public static boolean playsShakeSound(int ticksUsingItem) {
        return ticksUsingItem >= 0 && ticksUsingItem % 10 == 0;
    }

    public static boolean shouldAutoRelease(int ticks) {
     ...
     */
    public static int normalizePotionDurationTicks(int durationTicks) {
    ...
    public static OptionalInt ingredientColor(String itemId, OptionalInt catalogColor) {
    ...
    public static int mixIngredientColors(int... colors) {
        if (colors.length == 0) {
