...
| 自定义方块 | 38 | 23 个公开/结构方块（包含黑板、八种熏香、水龙头与四种储酒架柜），加上 15 个只供 CustomCrops 切换的葡萄阶段方块 |
| 家具 | 136 | 桌椅、沙发、吧台、灯具、画、三明治展板、酒桶、压榨桶、调酒器、酒瓶与杯具等 |
| 私有渲染物品 | 503 | 仅供 CE 方块模型、家具槽位、酒桶部件/液面、压榨液面及高脚凳/调酒器动态部件显示使用，不作为公共内容发放；野葡萄藤身直接使用原版垂泪藤状态 |
